  ...
  <div class="list">
    ...
    <div class="content" v-loading.body="loading">
      <div class="menu">
        ...
        <span class="category" style="max-width: 65%;height: 40px;line-height: 40px">{{ category }}</span>
      ...
      <ul class="wrapper">
        <li v-for="(item) in info" :key="item.id"
          ...
          <i class="el-icon-arrow-right" style="font-weight: bold;color: #009338"></i><span class="space">{{ item.title }}</span>
        </li>
      </ul>
    </div>
    <v-footer></v-footer>
